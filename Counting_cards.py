...
class player:
    ...
    def player_decide_split(self, player, dealer):
        ...
        if player.hand[0].face == player.hand[1].face:
            if self.high_low_index > self.split_strategy[player.hand[0].value - 2, dealer.hand[0].value - 2]:
                action = '4'  # split
                return action
    ...
    def counting_cards(self,player,dealer,deck):
        """
        ...
        for card in player.hand:
            if card.face in ['2', '3', '4', '5', '6']:
                ...
                pass
        # Also consider the cards in the split hand.
        ...
        for card in dealer.hand:
            if card.face in ['2', '3', '4', '5', '6']:
                ...
                pass
        player.high_low_index = 100 * player.card_points / cards_num
        print(player.high_low_index)
