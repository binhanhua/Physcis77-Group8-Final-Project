...
class Player:
    ...
    def print_hand(self):
        ...
        """
        #Begin with the subject: player or dealer
        if not self.dealer:
            new_str = "You have a "
        else:
    ...
    def sum_split_hand(self):
        """
        This function calculates the value of the split hand.
        """
        sum_split = 0
    ...
    def busted(self):
        ...
        And then determines the new sum of hand with ACE present.
        """
        if self.sum_hand() > 21:
            return True
        return False
    ...
    def busted_split_hand(self):
        ...
        if self.sum_split_hand() > 21:
            ...
            return True
        # for the convenience, because if a player has no second hand,
