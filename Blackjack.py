...
def play():
    ...
    #I like this idea! If the game crashes, it would be much trouble for the player,
    #but now the player understand why
...
def start_turn(player, dealer, deck):
    ...
    player.take_out(bet) #This is a quite good idea, a nice simulation of the money pool.
    print("Burn a card")
    deck.draw()
